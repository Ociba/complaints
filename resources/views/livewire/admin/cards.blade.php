<div>
    <div class="row g-3 g-md-4 g-lg-5">
        ...
        <div class="col-12 col-sm-6 col-lg-6 col-xl-4 col-xxl-2 mb-3 mb-md-4">
                ...
                <a href="{{ route('complaints.status', 'pending') }}" class="text-decoration-none">
                    <div class="card-body px-3 px-md-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="icon-circle bg-danger text-white"><i class="material-icons">pending_actions</i></div>
                        </div>
                        <div class="card-text">
                ...
                <a href="{{ route('complaints.status', 'resolved') }}" class="text-decoration-none">
                    <div class="card-body px-3 px-md-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="icon-circle bg-warning text-white"><i class="material-icons">task_alt</i></div>
                        </div>
                        <div class="card-text">
                            <div class="d-inline-flex align-items-center fs-7 fs-md-6">
                                <i class="material-icons icon-xs text-success">arrow_upward</i>
                ...
                <a href="{{ route('complaints.type', 'text') }}" class="text-decoration-none">
                    <div class="card-body px-3 px-md-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="icon-circle bg-secondary text-white"><i class="material-icons">text_fields</i></div>
                        </div>
                        <div class="card-text">
                            <div class="d-inline-flex align-items-center fs-7 fs-md-6">
                                <i class="material-icons icon-xs text-success">arrow_upward</i>
                ...
                <a href="{{ route('complaints.type', 'audio') }}" class="text-decoration-none">
                    <div class="card-body px-3 px-md-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="icon-circle bg-info text-white"><i class="material-icons">mic</i></div>
                        </div>
                        <div class="card-text">
                            <div class="d-inline-flex align-items-center fs-7 fs-md-6">
                                <i class="material-icons icon-xs text-success">arrow_upward</i>
                ...
                <a href="{{ route('complaints.type', 'video') }}" class="text-decoration-none">
                    <div class="card-body px-3 px-md-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="icon-circle bg-success text-white"><i class="material-icons">videocam</i></div>
                        </div>
                        <div class="card-text">
                            <div class="d-inline-flex align-items-center fs-7 fs-md-6">
                                <i class="material-icons icon-xs text-success">arrow_upward</i>
                ...
                <a href="/admin/settings/system_user" class="text-decoration-none">
                    <div class="card-body px-3 px-md-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="icon-circle bg-primary text-white"><i class="material-icons">groups</i></div>
                        </div>
                        <div class="card-text">
                            <div class="d-inline-flex align-items-center fs-7 fs-md-6">
                                <i class="material-icons icon-xs text-success">arrow_upward</i>
