    ...
    <div class="row gx-5">
        <div class="col-xxl-3 col-md-6 mb-5">
            <div class="card card-raised border-start border-danger border-4">
                <a href="/admin/complaints" style="text-decoration:none;">
                    <div class="card-body px-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div class="me-2">
                                <div class="display-5">{{ \App\Models\Complaint::countPendingComplaints() }}</div>
                                <div class="card-text">Total Number Of Pending Complaints</div>
                            </div>
                    ...
                    <div class="card-body px-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div class="me-2">
                                ...
                                <div class="card-text">Total Number Of Resolved Complaints</div>
                            </div>
                    ...
                    <div class="card-body px-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div class="me-2">
                                ...
                                <div class="card-text">Total Number Of Text Complaints</div>
                            </div>
                    ...
                    <div class="card-body px-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div class="me-2">
                                ...
                                <div class="card-text">Total Number Of Audio Complaints</div>
                            </div>
                    ...
                    <div class="card-body px-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div class="me-2">
                                ...
                                <div class="card-text">Total Number Of Video Complaints</div>
                            </div>
                    ...
                    <div class="card-body px-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div class="me-2">
                                ...
                                <div class="card-text">Total Number Of Domestic Workers</div>
                            </div>
