          ...
          <div class="col-lg-5" data-aos="zoom-out">
            <div class="visual-content">
              <div class="fluid-shape">
                <img src="{{ asset('asset/front/assets/img/abstract/abstract-1.webp')}}" alt="Abstract Fluid Shape" class="fluid-img">
              </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="advertise-1 d-flex flex-column flex-lg-row gap-4 align-items-center position-relative">
          ...
          <div class="content-right position-relative" data-aos="fade-left" data-aos-delay="300">
            <img src="{{ asset('asset/front/assets/img/misc/misc-1.webp')}}" alt="Digital Platform" class="img-fluid rounded-4">
                ...
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="{{ asset('asset/front/assets/img/person/person-m-7.webp')}}" class="profile-img" alt="">
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="{{ asset('asset/front/assets/img/person/person-m-7.webp')}}" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="{{ asset('asset/front/assets/img/person/person-f-8.webp')}}" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Sara Wilsson</h3>
                        <span>Designer</span>
                      </div>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="{{ asset('asset/front/assets/img/person/person-f-8.webp')}}" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="{{ asset('asset/front/assets/img/person/person-m-9.webp')}}" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Matt Brandon</h3>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="{{ asset('asset/front/assets/img/person/person-m-9.webp')}}" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="{{ asset('asset/front/assets/img/person/person-f-10.webp')}}" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Jena Karlis</h3>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="{{ asset('asset/front/assets/img/person/person-f-10.webp')}}" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row g-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-ui">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="{{ asset('asset/front/assets/img/portfolio/portfolio-1.webp')}}" class="img-fluid" alt="" loading="lazy">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-development">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="{{ asset('asset/front/assets/img/portfolio/portfolio-10.webp')}}" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-photography">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="{{ asset('asset/front/assets/img/portfolio/portfolio-7.webp')}}" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-marketing">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="{{ asset('asset/front/assets/img/portfolio/portfolio-4.webp')}}" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-ui">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="{{ asset('asset/front/assets/img/portfolio/portfolio-2.webp')}}" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      <div class="entry-meta">UI/UX Design</div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-development">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="{{ asset('asset/front/assets/img/portfolio/portfolio-11.webp')}}" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      <div class="entry-meta">Development</div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-photography">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="{{ asset('asset/front/assets/img/portfolio/portfolio-8.webp')}}" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      <div class="entry-meta">Photography</div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-marketing">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="{{ asset('asset/front/assets/img/portfolio/portfolio-5.webp')}}" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      <div class="entry-meta">Marketing</div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="{{ asset('asset/front/assets/img/person/person-m-7.webp')}}" class="img-fluid" alt="" loading="lazy">
              </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="{{ asset('asset/front/assets/img/person/person-f-8.webp')}}" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
                <h4>Sarah Jhonson</h4>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="{{ asset('asset/front/assets/img/person/person-m-6.webp')}}" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="{{ asset('asset/front/assets/img/person/person-f-4.webp')}}" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
                <h4>Amanda Jepson</h4>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="500">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="{{ asset('asset/front/assets/img/person/person-m-12.webp')}}" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
                <h4>Brian Doe</h4>
                <span>Marketing</span>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="600">
            <div class="team-member d-flex">
              <div class="member-img">
                <img src="{{ asset('asset/front/assets/img/person/person-f-9.webp')}}" class="img-fluid" alt="" loading="lazy">
              </div>
              <div class="member-info flex-grow-1">
                <h4>Josepha Palas</h4>
                <span>Operation</span>
